...
function BorderTriangle() {
  return (
    <>
    <div id='borderContainer' className='w-[100%] bg-ghostWhite flex flex-col items-center justify-center pb-16 sm:pb-28 md:pb-40'>
    ...
    <div id='heroWrapper' className='absolute top-[400px] max-w-[375px] sm:max-w-[465px] md:max-w-[530px]'>
        <div id='heroImageContainer' className='pr-4 pl-8'>
