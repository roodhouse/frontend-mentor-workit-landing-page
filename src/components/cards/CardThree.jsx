...
function CardThree() {
  return (
    <div id='cardThreeContainer' className='flex flex-col justify-center items-center text-center lg:flex-row lg:text-left xl:flex-col xl:max-w-[335px]'>
        <div id='numberThreeContainer' className='pb-6 pr-8 xl:pb-14'>
            <p className='font-["Fraunces"] text-darkPurple text-xl font-semibold leading-9 text-center px-4 py-[5px] border-[1px] border-davyGrey rounded-full xl:text-2xl xl:leading-10'>3</p>
        </div>
